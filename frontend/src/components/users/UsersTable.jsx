...
const userData = [
  ...
  },
  {
    id: 2,
    name: 'Murtala Muazu',
    email: 'murtala.muazu@mbep.sok.gov',
    role: 'Staff',
    status: 'Active',
  },
  {
          ...
          <tbody className="divide-y divide-gray-700">
            {filteredUsers.map((user) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="px-2 inline-flex text-xl leading-5 font-semibold rounded-full bg-blue-800 text-blue-100">
                    {user.role}
                  </span>
                </td>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span
                    className={`px-2 inline-flex text-xl leading-5 font-semibold rounded-full ${
                      user.status === 'Active'
